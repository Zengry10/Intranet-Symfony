...
class StudentController extends AbstractController
{
    ...
    public function show(Student $student,  gradeRepository $gradeRepository, grade $grade, studentRepository $studentRepository): Response
    {
        $gradeAverage = $gradeRepository->gradeAverageForStudent($student->getId());
